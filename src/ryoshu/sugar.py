...
async def into_builder(
    ...
    if isinstance(component, hikari.api.ComponentBuilder):
    ...
    elif isinstance(component, component_api.ManagedComponent):
        ...
        elif component.custom_id is not None:
...
async def into_action_rows(
    components: typing.Sequence[
        typing.Sequence[typing.Union[hikari.PartialComponent, hikari.api.ComponentBuilder, component_api.ManagedComponent]]
    ]
):
